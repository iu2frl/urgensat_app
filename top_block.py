...
# Title: Top Block
# Generated: Thu Jul  7 22:30:32 2022
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.connect((self.blks2_packet_decoder_0_0, 0), (self.blks2_tcp_sink_0_0, 0))
        ...
        self.connect((self.blocks_throttle_0_0, 0), (self.blks2_packet_encoder_0_0, 0))
        self.connect((self.channels_channel_model_0, 0), (self.digital_gmsk_demod_0, 0))
        self.connect((self.channels_channel_model_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.channels_channel_model_0_0, 0), (self.digital_gmsk_demod_0_0, 0))
        ...
        self.connect((self.digital_gmsk_mod_0_0, 0), (self.blocks_multiply_const_vxx_1_0, 0))
